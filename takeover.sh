#!/bin/sh
# Based on https://github.com/marcan/takeover.sh
set -e
...
(echo "kevin"; echo "kevin") | ./busybox chroot . /bin/passwd
...
echo
echo "------------------------------------------------------------------------------"
echo "All done. Continue here:"
echo "ssh -p 80 -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null root@$(hostname -i)"
echo "------------------------------------------------------------------------------"
